...
| Criterio / Entregable | Estado | Detalle y Evidencia |
| :--- | :---: | :--- |
...
A diferencia de un cambio funcional —que añade o modifica características de negocio—, refactorizar preserva strictly el comportamiento externo mientras optimiza la legibilidad, cohesión y mantenibilidad de la arquitectura del software.
